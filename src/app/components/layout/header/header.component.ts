...
export class HeaderComponent implements AfterViewInit {
  ...
  constructor(private store: Store<{ cart: any }>, @Inject(PLATFORM_ID) private platFormId: object, private ngZone:NgZone ) {
      ...
      let pathEls: any = document.querySelectorAll('path');
        ...
        pathEls.forEach((item: any) => {
          ...
          anime({
            ...
            duration: anime.random(2000, 5000), // Set a random animation duration between 1s and 3s
